...
def matmul(x: Any, y: Any, transpose_x: bool = ..., transpose_y: bool = ..., name: Optional[str] = ...): ...
def norm(
    x: Tensor,
...
def dist(x: Any, y: Any, p: int = ..., name: Optional[str] = ...): ...
def cond(
    x: Tensor,
...
def dot(x: Any, y: Any, name: Optional[str] = ...): ...
def cov(
    x: Tensor,
    rowvar: bool = ...,
    ddof: bool = ...,
...
def t(input: Any, name: Optional[str] = ...): ...
def cross(x: Any, y: Any, axis: int = ..., name: Optional[str] = ...): ...
...
def bmm(x: Any, y: Any, name: Optional[str] = ...): ...
def histogram(input: Any, bins: int = ..., min: int = ..., max: int = ..., name: Optional[str] = ...): ...
def bincount(x: Any, weights: Optional[Any] = ..., minlength: int = ..., name: Optional[str] = ...): ...
def mv(x: Any, vec: Any, name: Optional[str] = ...): ...
