...
def create_convert_shape_node(var_shape_node: Any, slice_node: Any | None = ..., in_control_flow: bool = ...): ...
def create_choose_shape_node(attr_shape_name: Any, api_shape_name: Any, slice_node: Any | None = ...): ...
