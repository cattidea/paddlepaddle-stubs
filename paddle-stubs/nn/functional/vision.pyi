...
def affine_grid(theta: Any, out_shape: Any, align_corners: bool = ..., name: Optional[str] = ...): ...
def grid_sample(
    x: Any, grid: Any, mode: str = ..., padding_mode: str = ..., align_corners: bool = ..., name: Optional[str] = ...
): ...
def pixel_shuffle(x: Any, upscale_factor: Any, data_format: str = ..., name: Optional[str] = ...): ...
