...
class L1Loss(Layer):
    reduction: Any = ...
    name: Any = ...
    def __init__(self, reduction: str = ..., name: Optional[str] = ...) -> None: ...
    def forward(self, input: Any, label: Any): ...
...
class BCELoss(Layer):
    ...
    reduction: Any = ...
    name: Any = ...
    def __init__(self, weight: Optional[Any] = ..., reduction: str = ..., name: Optional[str] = ...) -> None: ...
    def forward(self, input: Any, label: Any): ...

class NLLLoss(Layer):
    def __init__(
        self, weight: Optional[Any] = ..., ignore_index: int = ..., reduction: str = ..., name: Optional[str] = ...
    ) -> None: ...
    def forward(self, input: Any, label: Any): ...
...
class MarginRankingLoss(Layer):
    ...
    reduction: Any = ...
    name: Any = ...
    def __init__(self, margin: float = ..., reduction: str = ..., name: Optional[str] = ...) -> None: ...
...
class SmoothL1Loss(Layer):
    ...
    delta: Any = ...
    name: Any = ...
    def __init__(self, reduction: str = ..., delta: float = ..., name: Optional[str] = ...) -> None: ...
    def forward(self, input: Any, label: Any): ...
