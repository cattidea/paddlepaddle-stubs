...
class Event:
    ...
    def record_batch(self, usetime: Any, num_samples: Any | None = ...) -> None: ...
...
class TimeAverager:
    def __init__(self) -> None: ...
    def reset(self) -> None: ...
    def record(self, usetime: Any, num_samples: Any | None = ...) -> None: ...
...
class Benchmark:
    ...
    events: Any = ...
    def __init__(self) -> None: ...
    def step(self, num_samples: Any | None = ...) -> None: ...
