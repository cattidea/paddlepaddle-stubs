...
class InMemoryDataset(DatasetBase):
    ...
    def preload_into_memory(self, thread_num: Any | None = ...) -> None: ...
    def wait_preload_done(self) -> None: ...
    def local_shuffle(self) -> None: ...
    def global_shuffle(self, fleet: Any | None = ..., thread_num: int = ...) -> None: ...
    def release_memory(self) -> None: ...
    def get_pv_data_size(self): ...
    def get_memory_data_size(self, fleet: Any | None = ...): ...
    def get_shuffle_data_size(self, fleet: Any | None = ...): ...

class QueueDataset(DatasetBase):
    def __init__(self) -> None: ...
    def local_shuffle(self) -> None: ...
    def global_shuffle(self, fleet: Any | None = ...) -> None: ...
