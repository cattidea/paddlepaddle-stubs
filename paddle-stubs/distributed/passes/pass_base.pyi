...
class PassContext:
    ...
    def get_attr(self, key: Any, default: Any | None = ...): ...
    @property
    def passes(self): ...
...
class PassBase(ABC, metaclass=abc.ABCMeta):
    ...
    def get_attr(self, key: Any, default: Any | None = ...): ...
    def apply(self, main_programs: Any, startup_programs: Any, context: Any | None = ...): ...
...
class PassManager:
    def __init__(self, passes: Any, context: Any | None = ..., auto_solve_conflict: bool = ...) -> None: ...
