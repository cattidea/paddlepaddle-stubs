...
class TunableSpace:
    ...
    def choice(self, name: Any, values: Any, default: Any | None = ...): ...
    def int_range(self, name: Any, start: Any, stop: Any, step: int = ..., default: Any | None = ...): ...
    def float_range(self, name: Any, start: Any, stop: Any, step: Any | None = ..., default: Any | None = ...): ...
    def get_state(self): ...
    @classmethod
