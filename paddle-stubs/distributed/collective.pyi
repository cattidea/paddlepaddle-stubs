...
def new_group(ranks: Any | None = ..., backend: Any | None = ...): ...
def wait(tensor: Any, group: Any | None = ..., use_calc_stream: bool = ...) -> None: ...
def broadcast(tensor: Any, src: Any, group: Any | None = ..., use_calc_stream: bool = ...): ...
def all_reduce(tensor: Any, op: Any = ..., group: Any | None = ..., use_calc_stream: bool = ...): ...
def reduce(tensor: Any, dst: Any, op: Any = ..., group: Any | None = ..., use_calc_stream: bool = ...): ...
def all_gather(tensor_list: Any, tensor: Any, group: Any | None = ..., use_calc_stream: bool = ...) -> None: ...
def scatter(
    tensor: Any,
    tensor_list: Any | None = ...,
    src: int = ...,
    group: Any | None = ...,
...
def alltoall(
    in_tensor_list: Any, out_tensor_list: Any, group: Any | None = ..., use_calc_stream: bool = ...
) -> None: ...
def send(tensor: Any, dst: int = ..., group: Any | None = ..., use_calc_stream: bool = ...): ...
def recv(tensor: Any, src: int = ..., group: Any | None = ..., use_calc_stream: bool = ...): ...
