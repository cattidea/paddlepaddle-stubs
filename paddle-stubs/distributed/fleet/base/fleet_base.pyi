...
class Fleet:
    ...
    def init(self, role_maker: Any | None = ..., is_collective: bool = ..., strategy: Any | None = ...) -> None: ...
    ...
    def init_worker(self, scopes: Any | None = ...) -> None: ...
    ...
    def save_persistables(
        self, executor: Any, dirname: Any, main_program: Any | None = ..., mode: int = ...
    ) -> None: ...
    def shrink(self, threshold: Any | None = ...) -> None: ...
